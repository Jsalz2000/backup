...
.. code-block:: console
    ...
    # Download the package
    wget https://twindb-release.s3.amazonaws.com/twindb-backup/3.5.0/focal/twindb-backup_3.5.0-1_amd64.deb
    # Install TwinDB Backup
    apt install ./twindb-backup_3.5.0-1_amd64.deb
...
.. code-block:: console
    ...
    $ ls omnibus/pkg/*.deb
    omnibus/pkg/twindb-backup_3.5.0-1_amd64.deb
